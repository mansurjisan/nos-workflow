...
operationally:
  ...
  * Model zero really is xGEOID20B. STOFS-3D-AK ships no xgeoid->datum .nco
    ...
    Felicio Cassalho, not an established fact. If it is wrong, every factor
    here is off by the same constant, not sign-flipped.
...
# If wrong, every factor below shifts by one constant, not a sign flip.
#
