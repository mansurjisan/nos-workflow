...
#  forecast job (exnos_ofs_forecast.sh) can retrieve it.
#
#  Usage:
#    Called by JNOS_OFS_NOWCAST (STOFS): $SCRIstofs3d/exnos_ofs_nowcast.sh
#    Called by JNOS_OFS_NOWCAST (COMF):  $SCRIPTSnos/exnos_ofs_nowcast.sh $OFS
##############################################################################
