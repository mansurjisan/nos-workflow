...
###########################################################################
#  Name: stofs_3d_pac_create_awips_shef.sh                                # 
...
#  date, stofs_3d_pac.t12z.points.cwl.shef.                               #
#                                                                         #
#  Remarks:                                                               #
#                                                       September, 2022   #
###########################################################################
...
set -x
  ...
  fn_this_sh="stofs_3d_pac_create_awips_shef.sh"
...
# ---------------------------> Global Variables
  fin_staout_nc_json=${FIXstofs3d}/stofs_3d_pac_staout_nc.json
  
  fin_staout_nc_csv=${FIXstofs3d}/stofs_3d_pac_staout_nc.csv

  fn_nco_xg_navd=${FIXstofs3d}/stofs_3d_pac_sta_cwl_xgeoid_to_navd.nco
  fin_shef_navd88_mllw=${FIXstofs3d}/stofs_3d_pac_sta_awips_shef_navd88_mllw.txt
  ...
  fn_exe_gen_nc2shef=${EXECstofs3d}/stofs_3d_pac_netcdf2shef
