...
################################################################################
#  Name: stofs_3d_pac_create_bctides_in.sh                                     # 
#  This script creates the tidal forcing file, stofs_3d_pac.t12z.bctides.in,   #
...
set -x
  ...
  echo 'stofs_3d_pac_create_bctides_in.sh started'
...
# --------------------------->
 rm -f bctides.in*
  ...
  fn_generate_bctides_in=${EXECstofs3d}/stofs_3d_pac_tide_fac
  fn_bctides_in_template=${FIXstofs3d}/stofs_3d_pac_bctides.in_template
...
echo 
echo 'stofs_3d_pac_create_bctides_in.sh completed ' 
echo ' '
