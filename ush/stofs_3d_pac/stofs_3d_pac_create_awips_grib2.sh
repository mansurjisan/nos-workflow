...
#################################################################################
#  Name: stofs_3d_pac_create_awips_grib2.sh                                     #
...
#  another post-processing script, stofs_3d_pac_create_adcirc_nc.sh, in         #
#  the same directory as this script) to create the AWIPS WGRIB-format          #
#  time series files,                                                           #
#  (1) U.S. east conus are                                                      #
#   - separated hourly: stofs_3d_pac.t12z.conus.east.f{000,001,...,048}.grib2   #
#   - combined hourly:  stofs_3d_pac.t12z.conus.east.cwl.grib2                  #
#  (2) Puerto Rico area                                                         #
#    - separated hourly: stofs_3d_pac.t12z.puertori.f{000,001,...,048}.grib2     #
#    - combined hourly:  stofs_3d_pac.t12z.puertori.cwl.grib2                    #
#                                                                               #
#  Remarks:                                                                     #
#                                                             September, 2022   #
...
set -x
  ...
  fn_this_sh="stofs_3d_pac_create_awips_grib2.sh"
...
# ---------------------------> Global Variables
  fin_mask_conus_east_us=${FIXstofs3d}/stofs_3d_pac_awips_mask_conus_us_east.txt
  fin_mask_puertorico=${FIXstofs3d}/stofs_3d_pac_awips_mask_puerto_rico.txt


  fn_exe_gen_grib2=${EXECstofs3d}/stofs_3d_pac_netcdf2grib
...
# ------------------> create AWIPS grib2 files
     ...
     # AWIPS grib2 cwl
      ...
      grid=puertori
       ...
       fn_PARMstofs=${PARMstofs3d}/grib2_stofs_3d_pac_puertori_cwl
     ...
     grid=conus.east
       ...
       fn_PARMstofs=${PARMstofs3d}/grib2_stofs_3d_pac_conus.east_cwl
       tocgrib2 < $fn_PARMstofs > out_${grid}.txt 2> errfile_${grid}.txt
