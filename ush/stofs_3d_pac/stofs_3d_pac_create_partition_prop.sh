...
#################################################################################################################
#  Name: stofs_3d_pac_create_partition_prop.sh                                                                #
#                                                                                                               #
...
# ----------------------->
  fn_this_script=stofs_3d_pac_create_partition_prop.sh
...
if [[ ${nproc_default_fix_plus_1} -eq ${nproc_tgt} ]]; then
  ...
  echo " In stofs_3d_pac_create_partition_prop.sh: "
  ...
  # ---------->
    ...
    # ---------> Create new partition.prop
     ...
     _GRAPH_PREFIX=${RUN:-stofs_3d_pac}
