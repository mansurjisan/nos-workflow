...
if [[ $netwk = gfs ]];then
 ...
 case $typef in
  sfgges) geslist='
   $COMINges/gfs.$day/${cyc}/atmos/gfs.t${cyc}z.sfcf$fh3.nc'
   ;;
  rtofs_spin_a) geslist='
   $COMINrtofs/rtofs.$day/rtofs_glo.t${cyc}z.n$fh.archv.a'
   ;;
  rtofs_nfcst_a) geslist='
   $COMINrtofs/rtofs.$day/rtofs_glo.t${cyc}z.f$fh.archv.a'
   ;;
  rtofs_spin_b) geslist='
   $COMINrtofs/rtofs.$day/rtofs_glo.t${cyc}z.n$fh.archv.b'
   ;;
  rtofs_nfcst_b) geslist='
