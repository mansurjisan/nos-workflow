...
##################################################################################
#  Name: stofs_3d_atl_create_obc_3dth.sh                                   #
...
# set -x
  ...
  fn_this_script="stofs_3d_atl_create_obc_3dth.sh"
...
# ---------------------------> Global Variables
  ...
  fn_input_gen_nudge=${FIXstofs3d}/stofs_3d_atl_obc_3dth_nc.in
