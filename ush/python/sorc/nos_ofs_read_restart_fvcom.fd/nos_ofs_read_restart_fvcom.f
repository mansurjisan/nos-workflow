...
!      PRINT *,trim(VNAME),ocean_time,NTIMES
      ...
      IF ( (day_start-day_hotrestart) .LE. 0.0 )THEN
        write(*,*)'restart time is greater than or equal to end of simulation time'
	write(*,*)'initial time= ',day_hotrestart
        write(*,*)'simulation end time= ',day_start
	write(*,*)'Please check initial file and restart time'
	write(*,*)TRIM(OFS)//' in nos_ofs_read_restart.f'
!	stop
